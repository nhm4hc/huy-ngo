...
void LCD12864_Init()
{
	LCD12864_PSB = 1;	  //Chon che do dau vao song song
	LCD12864_RST = 1;	  //dat lai

	LCD12864_WriteCmd(0x30);  //chon thao tac lenh co ban
	LCD12864_WriteCmd(0x0c);  //Hien thi bat va tat co tro?
	LCD12864_WriteCmd(0x01);  //X骯 noi dung hien thi cua LCD12864
}
...
void LCD12864_SetWindow(uchar x, uchar y)
{
	...
	if(x == 0)	     //dia chi cua dong dau tien 80H
		x = 0x80;
	else if(x == 1)  //dia chi cua dong thu hai 90H
		x = 0x90;	
	else if(x == 2)  //dia chi cua dong thu ba 88H
		x = 0x88;
	else if(x == 3)  //dia chi cua dong thu tu 98H
		x = 0x98;
